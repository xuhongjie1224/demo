...
probe_exprs<-GSE14975.probe_exprs
...
head(exp)
GSE14975exp<-exp
GSE14975exp<-GSE14975exp[,c(2:12)]
GSE14975ids<-ids
GSE14975group_list<-group_list
save(GSE14975exp,GSE14975group_list,GSE14975ids,
     file = "GSE14975step2output.Rdata")


mergeexp<-GSE14975exp
...
save(exp,group_list,deg,logFC_t,P.Value_t,file = "GSE14975step4output.Rdata")
